...
<body>
    ...
    <?php
        ...
        $result = mysqli_query($con, "SELECT * FROM entries WHERE branch='Artificial Intelligence and Data Science' AND course IN ('b.e', 'b.tech', 'B.e', 'B.Tech', 'B.E', 'B.TECH', 'B.E/B.Tech')");  
