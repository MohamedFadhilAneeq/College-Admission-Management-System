...
<body>
    ...
    <?php
        ...
        $result = mysqli_query($con, "SELECT * FROM entries WHERE branch='Artificial Intelligence and Machine Learning' AND course IN ('b.e', 'b.tech', 'B.e', 'B.Tech', 'B.E', 'B.TECH', 'B.E/B.Tech')");  
